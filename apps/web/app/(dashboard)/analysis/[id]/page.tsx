...
export default function AnalysisPage() {
  ...
  const handleCopyLink = () => {
    const nameParams = Object.entries(playerNames).filter(([,v]) => v).map(([k,v]) => k + "=" + encodeURIComponent(v)).join("&"); navigator.clipboard.writeText(`https://pickleballvideoiq.netlify.app/share/${id}` + (nameParams ? "?" + nameParams : ""));
    setCopied(true);
